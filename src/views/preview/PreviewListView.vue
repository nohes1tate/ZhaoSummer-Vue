  ...
  <div>
    <div class="axure-leftnav">
      ...
      >
        ...
        <el-menu-item index="newAxure" @click="newAxureDialogVisible = true" v-show="newPage && isPage"><i class="el-icon-plus"></i>新建页面</el-menu-item>
        <el-menu-item index="newAxure" v-show="newPage && (!isPage)" @click="toNewUML"><i class="el-icon-plus" ></i>新建UML图</el-menu-item>
      </el-menu>
    </div>
    ...
    <div class="no-group" v-show="newPage && isPage">
      <span style="font-size: 40px; color: #595959">创建原型</span>
    ...
    <div class="no-group" v-show="newPage && (!isPage)">
      <span style="font-size: 40px; color: #595959">创建UML</span>
...
export default {
  ...
  created() {
    ...
    console.log('here')
    console.log(this.axureList.length)
          ...
          .then(res => {
            switch (res.data.error) {
              case 0:
                ...
                this.$router.push('/design/'+this.projectID)
                break;
            }
          })
          .catch(err => {
