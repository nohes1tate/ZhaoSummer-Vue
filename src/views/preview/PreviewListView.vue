      ...
      <el-dialog title="新建页面" :visible.sync="newAxureDialogVisible" :append-to-body="true">
        ...
        <div class="create-app-select-content">
          <div class="rp-type">
            ...
            <el-dropdown style="margin-top: 10px; width: 100%; text-align: center;" @command="selectPhone" placement="bottom">
          ...
          <div class="rp-type">
            ...
            <el-dropdown style="margin-top: 10px; width: 100%; text-align: center;" @command="selectPad" placement="bottom">
              <span class="el-dropdown-link">
          ...
          <div class="rp-type">
            ...
            <el-dropdown style="margin-top: 10px; width: 100%; text-align: center;" @command="selectWeb" placement="bottom">
              <span class="el-dropdown-link">
          ...
          <div class="rp-type">
            ...
            <div style="margin-top: 10px; width: 100%; text-align: center;">
              ...
              <input class="input" type="number" min="50" max="1800" v-model="customWidth">
              <span style="color: #969798;">高</span>
              <input class="input" type="number" min="50" max="1800" v-model="customHeight">
            </div>
          </div>
        </div>
        <el-dialog
          ...
          <el-button @click="goAxurePreview">模板预览</el-button>
