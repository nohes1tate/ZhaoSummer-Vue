...
<script>
import { matchesSelectorToParentElements, getComputedSize, addEvent, removeEvent } from '@/components/vue-draggable-resizable/utils/dom'
import { computeWidth, computeHeight, restrictToBounds, snapToGrid } from '@/components/vue-draggable-resizable/utils/fns'
